...
urlpatterns=[
 ...
 path("inscripciones/",views.inscripciones,name="inscripciones"),path("inscripciones/<int:pk>/",views.inscripcion_detalle,name="inscripcion_detalle"),path("estudiantes/<int:alumno_pk>/inscripciones/nueva/",views.inscripcion_form,name="inscripcion_crear"),path("estudiantes/<int:alumno_pk>/inscripciones/<int:pk>/editar/",views.inscripcion_form,name="inscripcion_editar"),path("inscripciones/<int:pk>/retirar/",views.retirar,name="retirar"),
