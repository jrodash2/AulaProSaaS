...
class ConceptoForm(AulaProFormMixin, forms.ModelForm):
...
class ConfiguracionForm(AulaProFormMixin, forms.ModelForm):
...
class CargoForm(AulaProFormMixin, forms.ModelForm):
...
class PagoForm(AulaProFormMixin, forms.Form):
 ...
 def clean(self):
  ...
  return d
class GenerarForm(AulaProFormMixin, forms.Form):
